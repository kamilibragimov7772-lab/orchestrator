...
subprocess.run([FF, "-y", "-hide_banner", "-loglevel", "error", "-f", "lavfi", "-i",
                ...
                "-c:v", "libx264", "-preset", "veryfast", "-crf", "20", intro], check=True)
...
subprocess.run([FF, "-y", "-hide_banner", "-loglevel", "error", "-f", "lavfi", "-i",
                ...
                "-c:v", "libx264", "-preset", "veryfast", "-crf", "20", outro], check=True)
...
subprocess.run([FF, "-y", "-hide_banner", "-loglevel", "error", "-i", silent, "-i", CLEAN,
                ...
                "-c:a", "aac", "-b:a", "192k", OUTFILE], check=True)
